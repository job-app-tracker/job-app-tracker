<template>
  <v-layout row wrap>
    ...
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_sub_title" label="*Position">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
    ...
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_interview1" label="Interview 1">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_interview2" label="Interview 2">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
    ...
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_description" label="Description">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
    ...
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_company_title" label="Company Title">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field
        v-model="new_job_company_description"
        label="Company description"
      >
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_company_website" label="Company Website">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_company_founded" label="Company founded">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_company_type" label="Company Type">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_company_country" label="Company Country">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field v-model="new_job_company_industry" label="Company industry">
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field
        v-model="new_job_company_alexa_global"
        label="Company alexa global rating"
      >
      </v-text-field>
    </v-flex>
    <v-flex xs4 class="pl-4 pr-4">
      <v-text-field
        v-model="new_job_company_alexa_usa"
        label="Company alexa usa rating"
      >
      </v-text-field>
    </v-flex>
    <v-flex xs12 class="pl-4 pr-4">
      <v-btn rounded outline color="#000" v-on:click="addNewJob()"
        >Add Job</v-btn
      >
    </v-flex>
  </v-layout>
